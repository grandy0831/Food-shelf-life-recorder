...
class Floor277Screen extends StatefulWidget {
  const Floor277Screen({super.key});

  @override
  _Floor277ScreenState createState() => _Floor277ScreenState();
}

class _Floor277ScreenState extends State<Floor277Screen> {
...
Widget buildCard(
  ...
  String adjustedAddress = "GF - One Pool Street, E20 2AF";
