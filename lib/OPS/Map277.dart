...
class Map277Screen extends StatefulWidget {
  const Map277Screen({super.key});

  @override
  _Map277ScreenState createState() => _Map277ScreenState();
}

class _Map277ScreenState extends State<Map277Screen> {
  List<Room>? _rooms;
  ...
  Future<void> _fetchRooms() async {
    ...
    try {
      final rooms = await fetchRoomsForFloor("Ground Floor");
      setState(() {
        _rooms = rooms;
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, Rect> workspaceAreas = {
       'Light Fabrication Workshop': Rect.fromLTWH(screenSize.width * 0.6, screenSize.height * 0.105, screenSize.width * 0.022, screenSize.height * 0.01),
    };
        ...
        children: [
          Expanded(
            ...
            child: InteractiveViewer(
              ...
              child: Stack(
                children: [
                  Image.asset('assets/images/G1.png', fit: BoxFit.cover),
