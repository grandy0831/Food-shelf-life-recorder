...
class Floor273Screen extends StatefulWidget {
  const Floor273Screen({super.key});

  @override
  _Floor273ScreenState createState() => _Floor273ScreenState();
}

class _Floor273ScreenState extends State<Floor273Screen> {
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return buildCard(
              ...
              room.totalSeats,
              () {
                // if (room.roomType == "Workspace 1") {
                //   Navigator.push(context, MaterialPageRoute(builder: (context) => const Floor274Screen())); //replace
                // } else if (room.roomType == "Workspace 2") {
                //   Navigator.push(context, MaterialPageRoute(builder: (context) => const Floor274Screen())); //replace
                // } else if (room.roomType == "Workspace 3") {
                //   Navigator.push(context, MaterialPageRoute(builder: (context) => const Floor274Screen())); //replace
                // } else if (room.roomType == "Workspace 4") {
                //   Navigator.push(context, MaterialPageRoute(builder: (context) => const Floor277Screen())); //replace
                // } else if (room.roomType == "Workspace 5") {
                //   Navigator.push(context, MaterialPageRoute(builder: (context) => const Floor277Screen())); //replace
                // } 
              },
            );
...
Widget buildCard(
  ...
  String adjustedAddress = "2F - One Pool Street, E20 2AF";
