...
const Map<String, int> room = {
  ...
  'Centrally Bookable Teaching Space': 1,
};
...
class Map274Screen extends StatefulWidget {
  const Map274Screen({super.key});

  @override
  _Map274ScreenState createState() => _Map274ScreenState();
}

class _Map274ScreenState extends State<Map274Screen> {
  List<Room>? _rooms;
  ...
  Future<void> _fetchRooms() async {
    ...
    try {
      final rooms = await fetchRoomsForFloor("Third Floor");
      setState(() {
        _rooms = rooms;
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, Rect> workspaceAreas = {
      'Accommodation Office': Rect.fromLTWH(screenSize.width * 0.275, screenSize.height * 0.2455, screenSize.width * 0.022, screenSize.height * 0.01),
      'Centrally Bookable Teaching Space': Rect.fromLTWH(screenSize.width * 0.495, screenSize.height * 0.085, screenSize.width * 0.022, screenSize.height * 0.01),
    };
        ...
        children: [
          Expanded(
            ...
            child: InteractiveViewer(
              ...
              child: Stack(
                children: [
                  Image.asset('assets/images/03-one-pool-street.png', fit: BoxFit.cover),
