...
class Floor272Screen extends StatefulWidget {
  const Floor272Screen({super.key});

  @override
  _Floor272ScreenState createState() => _Floor272ScreenState();
}

class _Floor272ScreenState extends State<Floor272Screen> {
...
Widget buildCard(
  ...
  String adjustedAddress = "1F - One Pool Street, E20 2AF";
