...
class Floor274Screen extends StatefulWidget {
  const Floor274Screen({super.key});

  @override
  _Floor274ScreenState createState() => _Floor274ScreenState();
}

class _Floor274ScreenState extends State<Floor274Screen> {
...
Widget buildCard(
  ...
  String adjustedAddress = "3F - One Pool Street, E20 2AF";
