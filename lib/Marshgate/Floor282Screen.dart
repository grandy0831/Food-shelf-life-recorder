...
class Floor282Screen extends StatefulWidget {
  const Floor282Screen({super.key});

  @override
  _Floor282ScreenState createState() => _Floor282ScreenState();
}

class _Floor282ScreenState extends State<Floor282Screen> {
  ...
  Future<void> _loadRooms() async {
    ...
    try {
      final rooms = await fetchRoomsForFloor("Floor 1");
      _allRooms = rooms;
      _filterRooms(_searchController.text);
    } catch (e) {
...
Widget buildCard(
  ...
  String adjustedAddress = "1F - Marshgate, E20 2AE";
