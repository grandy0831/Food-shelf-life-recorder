...
class Floor287Screen extends StatefulWidget {
  const Floor287Screen({super.key});

  @override
  _Floor287ScreenState createState() => _Floor287ScreenState();
}

class _Floor287ScreenState extends State<Floor287Screen> {
...
Widget buildCard(
  ...
  String adjustedAddress = "8F - Marshgate, E20 2AE";
