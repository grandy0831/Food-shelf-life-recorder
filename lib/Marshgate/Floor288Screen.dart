...
class Floor288Screen extends StatefulWidget {
  const Floor288Screen({super.key});

  @override
  _Floor288ScreenState createState() => _Floor288ScreenState();
}

class _Floor288ScreenState extends State<Floor288Screen> {
...
Widget buildCard(
  ...
  String adjustedAddress = "6F - Marshgate, E20 2AE";
