...
const Map<String, int> room = {
  ...
  'SE Workspace': 2,
  'NE Workspace': 3,
  'Student Support and Wellbeing': 4,
  'Workspace': 5,
  'Refectory': 6,
};
...
class Map294Screen extends StatefulWidget {
  const Map294Screen({super.key});

  @override
  _Map294ScreenState createState() => _Map294ScreenState();
}

class _Map294ScreenState extends State<Map294Screen> {
  List<Room>? _rooms;
