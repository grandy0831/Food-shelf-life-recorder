...
class Floor283Screen extends StatefulWidget {
  const Floor283Screen({super.key});

  @override
  _Floor283ScreenState createState() => _Floor283ScreenState();
}

class _Floor283ScreenState extends State<Floor283Screen> {
...
Widget buildCard(
  ...
  String adjustedAddress = "3F - Marshgate, E20 2AE";
