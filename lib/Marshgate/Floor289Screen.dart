...
class Floor289Screen extends StatefulWidget {
  const Floor289Screen({super.key});

  @override
  _Floor289ScreenState createState() => _Floor289ScreenState();
}

class _Floor289ScreenState extends State<Floor289Screen> {
...
Widget buildCard(
  ...
  String adjustedAddress = "7F - Marshgate, E20 2AE";
