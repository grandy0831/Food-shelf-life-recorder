...
class Map289Screen extends StatefulWidget {
  const Map289Screen({super.key});

  @override
  _Map289ScreenState createState() => _Map289ScreenState();
}

class _Map289ScreenState extends State<Map289Screen> {
  List<Room>? _rooms;
  ...
  Future<void> _fetchRooms() async {
    ...
    try {
      final rooms = await fetchRoomsForFloor("Floor 7");
      setState(() {
        _rooms = rooms;
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, Rect> workspaceAreas = {
      'Student Study Space': Rect.fromLTWH(screenSize.width * 0.545, screenSize.height * 0.085, screenSize.width * 0.022, screenSize.height * 0.01),
    };
        ...
        children: [
          Expanded(
            ...
            child: InteractiveViewer(
              ...
              child: Stack(
                children: [
                  Image.asset('assets/images/M7.jpg', fit: BoxFit.cover),
