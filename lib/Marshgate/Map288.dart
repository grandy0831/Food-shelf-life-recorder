...
const Map<String, Rect> workspaceAreas = {
  'NW Workspace': Rect.fromLTWH(160, 20, 10, 10),
  'SW Workspace': Rect.fromLTWH(80, 246, 10, 10),
  'Student Study Space': Rect.fromLTWH(240, 50, 10, 10),
  'SE Workspace': Rect.fromLTWH(335, 200, 10, 10),
...
class Map288Screen extends StatefulWidget {
  const Map288Screen({super.key});

  @override
  _Map288ScreenState createState() => _Map288ScreenState();
}

class _Map288ScreenState extends State<Map288Screen> {
  List<Room>? _rooms;
  ...
  Future<void> _fetchRooms() async {
    ...
    try {
      final rooms = await fetchRoomsForFloor("Floor 6");
      setState(() {
        _rooms = rooms;
        ...
        children: [
          Expanded(
            ...
            child: InteractiveViewer(
              ...
              child: Stack(
                children: [
                  Image.asset('assets/images/M6.jpg', fit: BoxFit.cover),
