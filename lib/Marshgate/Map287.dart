...
class Map287Screen extends StatefulWidget {
  const Map287Screen({super.key});

  @override
  _Map287ScreenState createState() => _Map287ScreenState();
}

class _Map287ScreenState extends State<Map287Screen> {
  List<Room>? _rooms;
  ...
  Future<void> _fetchRooms() async {
    ...
    try {
      final rooms = await fetchRoomsForFloor("Floor 8");
      setState(() {
        _rooms = rooms;
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, Rect> workspaceAreas = {
      'N Workspace': Rect.fromLTWH(screenSize.width * 0.56, screenSize.height * 0.085, screenSize.width * 0.022, screenSize.height * 0.01),
      'Student Study Space': Rect.fromLTWH(screenSize.width * 0.63, screenSize.height * 0.155, screenSize.width * 0.022, screenSize.height * 0.01),
    };
        ...
        children: [
          Expanded(
            ...
            child: InteractiveViewer(
              ...
              child: Stack(
                children: [
                  Image.asset('assets/images/M8.jpg', fit: BoxFit.cover),
